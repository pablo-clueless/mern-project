...
const InputField = ({label, type, name, onChange, placeholder, error}) => {
  return (
    <div className='w-full md:w-400 bg-transparent my-3'>
        ...
        <div className={`w-full h-11 bg-transparent border-thin px-4 py-2 focus-within:border-slate-400 ${error ? 'border-red-500 text-red-500' : 'border-primary text-primary'}`}>
